...
TEXTS = {
    'en': {
        ...
        'compare_projects_multi': "Compare multiple projects across months/years",
    ...
    'vi': {
        ...
        'compare_projects_month': "So sánh nhiều dự án trong một tháng",
        'compare_projects_year': "So sánh nhiều dự án trong một năm",
        'compare_projects_multi': "So sánh nhiều dự án qua các tháng/năm",
